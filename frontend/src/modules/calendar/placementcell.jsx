    ...
    const handleCreateEvent = async () => {
        ...
        try {
            ...
            if (error.response?.status === 409) {
                ...
                setErrorMsg(error.response?.data?.error || error.message || "Failed to create event");
            }
        }
    };
                    ...
                    <Stack direction="row" spacing={1} flexWrap="wrap" useFlexGap sx={{ gap: 1, width: { xs: "100%", md: "auto" }, justifyContent: { xs: "center", md: "flex-start" } }}>
                        ...
                        <Chip
                            ...
                            sx={{
                                ...
                                bgcolor: filterType === "posts" ? `${statusColors.posts}30` : "transparent",
                                color: filterType === "posts" ? statusColors.posts : "text.primary"
                            }}
                        />
                        <Chip
                            label="Events"
                            ...
                            sx={{
                                fontSize: { xs: "0.75rem", sm: "0.8125rem" },
                                bgcolor: filterType === "events" ? `${statusColors.events}30` : "transparent",
                                color: filterType === "events" ? statusColors.events : "text.primary"
                            }}
                        />
                        <Chip
                            label="Announcements"
                            ...
                            sx={{
                                fontSize: { xs: "0.75rem", sm: "0.8125rem" },
                                bgcolor: filterType === "announcements" ? `${statusColors.announcements}30` : "transparent",
                                color: filterType === "announcements" ? statusColors.announcements : "text.primary"
                            }}
                        />
                        <Chip
                            label="Drives"
                            ...
                            sx={{
                                fontSize: { xs: "0.75rem", sm: "0.8125rem" },
                                bgcolor: filterType === "drive" ? `${statusColors.drive}30` : "transparent",
                                color: filterType === "drive" ? statusColors.drive : "text.primary"
                            }}
                        />
                        <Chip
                            label="Tests"
                            ...
                            sx={{
                                fontSize: { xs: "0.75rem", sm: "0.8125rem" },
                                bgcolor: filterType === "tests" ? `${statusColors.tests}30` : "transparent",
                                color: filterType === "tests" ? statusColors.tests : "text.primary"
                            }}
                        />
                    </Stack>
                </Box>
