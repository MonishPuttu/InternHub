    ...
    const fetchAnalyticsData = async () => {
        try {
            ...
            const [strengthRes, statsRes] = await Promise.all([
                axios.get(`${BACKEND_URL}/api/placement-analytics/department-strength`, {
        ...
        <Box sx={{ p: 3, bgcolor: "#0f172a", minHeight: "100vh" }}>
            <Box sx={{ mb: 4 }}>
                ...
                <Typography variant="body2" sx={{ color: "#94a3b8" }}>
                    Comprehensive insights into department strength and placement performance
                </Typography>
            </Box>
            ...
            >
                ...
                >
                    <Typography variant="body2" sx={{ color: "#94a3b8", mb: 1 }}>
                        📊 Click the arrow icon above to view detailed application analytics by department
                    </Typography>
                    <Typography variant="caption" sx={{ color: "#64748b" }}>
                        Application analytics show how many students from each department have applied to job postings
                    </Typography>
                </Box>
            </Paper>
        </Box>
