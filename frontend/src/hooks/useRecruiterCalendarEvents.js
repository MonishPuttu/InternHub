...
const MY_POSTS_API = `${BACKEND_URL}/api/posts/my-posts`;

export const useRecruiterCalendarEvents = () => {
    ...
    const fetchAllEvents = async () => {
        ...
        try {
            ...
            // Fetch recruiter's own posts
            const postsResponse = await fetch(MY_POSTS_API, {
                headers: { Authorization: `Bearer ${token}` },
            });
            ...
            // Process recruiter's posts as events
            if (postsData.ok) {
